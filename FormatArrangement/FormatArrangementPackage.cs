...
namespace 迹I柳燕.FormatArrangement
{
    ...
    [Guid(GuidList.guidFormatArrangementPkgString)]
    public sealed class FormatArrangementPackage : Package
    {

        DTE dte;
        IVsUIShell uiShell;

        public FormatArrangementPackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                CommandID menuCommandID = new CommandID(GuidList.guidFormatArrangementCmdSet, (int)PkgCmdIDList.DocumentationCommand);
